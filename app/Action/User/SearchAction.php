 ...
 * @ResponseParam(n="list",                t="array",    e="list[]",     d="会员表数据列表")
 * @ResponseParam(n="list.0",                t="map",    e="{}",     d="会员表数据对象")
 * @ResponseParam(n="list.0.id",                t="int",    e="1",     d="序号")
 * @ResponseParam(n="list.0.username",                t="string",    e="xxx",     d="用户账号")
 * @ResponseParam(n="list.0.nickname",                t="string",    e="xxx",     d="昵称")
 * @ResponseParam(n="list.0.password",                t="string",    e="xxx",     d="密码")
 * @ResponseParam(n="list.0.avatar",                t="string",    e="xxx",     d="头像")
 * @ResponseParam(n="list.0.is_lock",                t="string",    e="xxx",     d="账号状态")
 * @ResponseParam(n="list.0.created_at",                t="string",    e="2020-07-01 12:00:00",     d="创建时间")
 * @ResponseParam(n="list.0.updated_at",                t="string",    e="2020-07-01 12:00:00",     d="更新时间")
 * @ResponseParam(n="current_page",                t="int",    e="1",     d="当前页数")
 * @ResponseParam(n="total",                t="int",    e="10",     d="总数量")
...
class SearchAction extends AbstractAction
{
    ...
    {
        return $this->successReturn($this->service->list($params));
    }
}
